...
export const SectionTechnologies = styled.section`
  display: ${(props) => props.grid ? "grid" : "flex" };
  flex-direction: ${(props) => props.row ? "row" : "column" };
  padding: ${(props) => props.nopadding ? "0" : "32px 48px 25px " } ;
  margin: 20px auto;
  max-width: 1040px;
  box-sizing: content-box;
  position: relative;
...
export const SectionTextTop = styled.h1`
  max-width: 800px;
  font-size: 50px;
  line-height: 40px;
  font-weight: 300;
...
export const SectionTextBottom = styled.h1`
  max-width: 800px;
  font-size: 50px;
  line-height: 40px;
  font-weight: 300;
...
export const SectionTextMain = styled.p`
...
export const SectionTextWorks = styled.p`
